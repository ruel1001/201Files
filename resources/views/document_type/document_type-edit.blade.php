                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="needs-validation" novalidate
                            action="/document_type/{{ $document_type->document_type_id}}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="document_type_name" id="document_type_name"
                                                ...
                                                cols="10" rows="5"
                                                placeholder="Document Remarks">{{old('document_type_status', $document_type->document_type_name)}}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="document_type_status"
                                                ...
                                                <option value="                                                    Active
                                                " {{old('document_type_status', $document_type->document_type_status)=='Active'
                                                    ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="Inactive"
                                                    {{ old('document_type_status', $document_type->document_type_status)=='Inactive' ? 'selected' : '' }}>
                                                    Inactive</option>
                                            </select>
