                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="text-right">
                                <a href="/department" class="btn btn-warning btn-sm"><i
                                        class="fa-solid fa-arrow-rotate-left"></i>
                                    Back
                                </a>
                            </div>
                        </div>
                        <form class="needs-validation" novalidate action="/department" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="department_name" id="department_name"
                                                ...
                                                cols="10" rows="5"
                                                placeholder="Document Remarks">{{old('department_name')}}</textarea>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="department_status"
                                                ...
                                                <option value="                                                    Active
                                                " {{ old('department_status')=='Active' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="Inactive"
                                                    {{ old('department_status')=='Inactive' ? 'selected' : '' }}>
                                                    Inactive</option>
                                            </select>
