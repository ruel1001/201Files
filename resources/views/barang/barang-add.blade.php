                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="category"
                                                ...
                                                id="category" placeholder="Category" value="{{old('category')}}"
                                                required>
                                            @error('category')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="supplier"
                                                ...
                                                id="supplier" placeholder="Supplier" value="{{old('supplier')}}"
                                                required>
                                            @error('supplier')
                                            <span class="invalid-feedback text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" id="note"
                                                class="form-control @error('note') is-invalid @enderror" cols="10"
