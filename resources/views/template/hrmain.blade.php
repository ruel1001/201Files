        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="/hmo/dashboard" class="d-block"
                            style="color: white;">{{ auth()->user()->first_name }}</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="/hmo/dashboard" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="/hrdocument" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a class="log-out ml-3" href="#" class="nav-link">
                                ...
                                Logout
                                <form action="/hmo/logout" method="POST" id="logging-out">
                                    @csrf
                                </form>
                            </a>
                        </li>
